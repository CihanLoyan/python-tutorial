...
rangeDizi = range(10)
print(rangeDizi, type(rangeDizi))

listeDonusum = list(range(10)) # Type Casting  
print(listeDonusum, type(listeDonusum))
print(list(range(2, 13)))
print(list(range(2, 13, 3)))

listeDonusum2 = [*range(10)] # Yukarıdaki yazıma alternatif düşünülebilir fakat yukarıdaki yazım tercih edilir.
print(listeDonusum2, type(listeDonusum2))

print([*range(3, 9, 2)])

print("***********************************************************************************")

harflerDizisi = ['a', 'b', 'c', 'd']
for i in enumerate(harflerDizisi):
    print(i)


harflerDizisi2 = ['a', 'b', 'c', 'd']
for index, harf in enumerate(harflerDizisi):
    print(f'Index: {index} \t Harf: {harf}')


harflerDizisi3 = ['a', 'b', 'c', 'd']
for index, harf in enumerate(harflerDizisi):
  print(f'{index + 1}. Harf: {harf}')


ulkeKısaltma = ['TR', 'DE', 'FR']
ulkeIsim = ['TÜRKİYE', 'almanya', 'fransa']
siralama = range(1, 4)

for i in zip(siralama, ulkeKısaltma, ulkeIsim):
    print(i)